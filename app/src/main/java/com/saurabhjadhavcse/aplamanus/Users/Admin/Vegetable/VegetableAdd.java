...
public class VegetableAdd extends AppCompatActivity {
    ...
    private final DatabaseReference root = FirebaseDatabase.getInstance().getReference("Vegetable");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itemNameEditTxt.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(VegetableAdd.this, "Please Select Image", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void uploadToFirebase(Uri imageUri) {
        final StorageReference fileRef = reference.child("Vegetable/" + System.currentTimeMillis() + "." + getFileExtension(imageUri));
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot snapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        VegetableModel model = new VegetableModel(modelId,uri.toString(), itemNameEditTxtToString, itemPriceEditTxtToString);
                        root.child(modelId).setValue(model);

                        progressBar.setVisibility(View.INVISIBLE);
                        Toast.makeText(VegetableAdd.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                progressBar.setVisibility(View.INVISIBLE);
                Toast.makeText(VegetableAdd.this, "Uploading Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
