package com.saurabhjadhavcse.aplamanus.Users.Customer.Chicken;
...
public class ChickenSee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chicken_see);
        ...
        chickenAdapter = new ChickenAdapter(chickenList, this);
