...
import com.saurabhjadhavcse.aplamanus.Users.Admin.Models.AdminMuttonAdapter;
import com.saurabhjadhavcse.aplamanus.Users.Admin.Models.MuttonModel;

import java.util.ArrayList;

public class SeeMutton extends AppCompatActivity {

    ArrayList<MuttonModel> muttonList;

    AdminMuttonAdapter muttonAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_mutton);
        ...
        muttonAdapter = new AdminMuttonAdapter(muttonList, this);
